 ...
 async handlePostETC(){
    ...
    if(this.data.carId!=""&&this.data.carName!=""&&this.recevieName!=""&&this.data.telephone!=""&&this.data.address!="")
    {
      var res = await getRequest({
        url:"http://175.24.57.96:90/consumer/etc/create?car="+this.data.carId+"&host="+this.data.carName+"&consignee="+this.data.recevieName+"&tel="+this.data.telephone+"&province="+this.data.region[0]+"&city="+this.data.region[1]+"&address="+this.data.address+"&openId="+wx.getStorageSync('openid')
